...
const words = ["Monthly Tasks", "Scheduled Meetings", "Event dates", "Work on reminders!"];
let wordIndex = 0;
let charIndex = 0;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  addTaskBtn.addEventListener('click', function () {
    ...
    newTask.innerHTML = `Task ${taskList.children.length + 1}: <textarea placeholder="Write your task here..."></textarea>`;
